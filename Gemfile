...
<link href="/assets/application-0b20213336300e616d6d7c5112dd45cd.css" media="all" rel="stylesheet" />
<link href="/assets/print-47fe51cdf70398e5e54b544e0f5cc718.css" media="print" rel="stylesheet" />
<script src="/assets/application-0c267d7a69b02a835dde6c15732931ad.js"></script>
<meta content="authenticity_token" name="csrf-param" />
<meta content="5a9YxFsPWtuiwMVOMfeejW01rUPZXXwXuP3Ta2dDyLg=" name="csrf-token" />
<script type="text/javascript">
//<![CDATA[
window.gon={};gon.api_version="v3";gon.default_avatar_url="https://poetic-git.githost.io/assets/no_avatar-0b64d25ac5f63e6f0caee99e819105ba.png";gon.default_issues_tracker="gitlab";gon.max_file_size=10;gon.relative_url_root="";gon.user_color_scheme="white";
//]]>
</script>
...
<img alt="Logo" src="/assets/logo-ca207549507c811d027110077cf86e90.svg" />
</div>
</div>
</header>
...
<form accept-charset="UTF-8" action="/users/sign_in" class="new_user" id="new_user" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="5a9YxFsPWtuiwMVOMfeejW01rUPZXXwXuP3Ta2dDyLg=" /></div><input autocapitalize="off" autocorrect="off" autofocus="autofocus" class="form-control top" id="user_login" name="user[login]" placeholder="Username or Email" type="text" />
...
<div class='login-body'>
<form accept-charset="UTF-8" action="/users" class="new_user" id="new_user" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="5a9YxFsPWtuiwMVOMfeejW01rUPZXXwXuP3Ta2dDyLg=" /></div><div class='devise-errors'>
